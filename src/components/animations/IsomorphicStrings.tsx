...
const EXAMPLES = [
  { 
    ...
    input: 's = "egg", t = "add"', 
    output: 'true',
    explanation: <>'e' maps to 'a', 'g' maps to 'd'. All characters map consistently.</>
  },
  { 
    label: 'Example 2', 
    input: 's = "foo", t = "bar"', 
    output: 'false',
    explanation: <>'o' attempts to map to both 'a' and 'r', which is invalid.</>
  },
  { 
    label: 'Example 3', 
      ...
      <VPBody 
        left={
          <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
                      ...
                      return (
                        <motion.div 
                          ...
                          style={{
                            ...
                            background: isConflict ? 'rgba(255, 107, 107, 0.2)' : isCurr ? 'rgba(78, 205, 196, 0.15)' : 'var(--surface)',
                    ...
                    {T.split('').map((char, i) => {
                      ...
                      return (
                        <motion.div 
                          ...
                          style={{
                            width: '40px', height: '40px',
                            background: isConflict ? 'rgba(255, 107, 107, 0.2)' : isCurr ? 'rgba(255, 107, 107, 0.15)' : 'var(--surface)',
            ...
            <StepCard title={step === TIMELINE.length - 1 ? "Done!" : "Mapping Characters"} desc={current.desc} step={step} maxSteps={TIMELINE.length} isDone={step === TIMELINE.length - 1} />
          </div>
        }
        right={
